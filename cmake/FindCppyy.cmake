...
function(cppyy_add_bindings pkg pkg_version author author_email)
  ...
  ####################################################
    ...
    list(APPEND std_args "\\\\-std=c++${ARG_LANGUAGE_STANDARD}")
    ...
    COMMAND ${Cppyy_EXECUTABLE} ${cling_args} --cxxflags "\"${std_args}\""
            ${ARG_H_FILES} ${out_linkdef} WORKING_DIRECTORY ${pkg_dir})
