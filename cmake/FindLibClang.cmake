...
# find what we have.
#
find_library(LibClang_LIBRARY libclang.so PATH_SUFFIXES $ENV{CONDA_PREFIX}/lib
x86_64-linux-gnu llvm llvm-11/lib)
...
message(STATUS "LibClang_PYTHON_EXECUTABLE: ${LibClang_PYTHON_EXECUTABLE}")
if(LibClang_LIBRARY)
